...
<div class="page-wrap">
    <div class="w">
        <div class="user-con">
            ...
            <div class="user-box">
            <form role="form" action="${pageContext.request.contextPath }/user/login.do" method="post" onsubmit="return check()">
                <font color="red">
                    <%-- 提示信息--%>
                ...
                <div class="link-item">
                    <a href="${pageContext.request.contextPath }/user/register.do" class="link" target="_blank">免费注册</a>
                </div>
            </form>
            </div>
        </div>
